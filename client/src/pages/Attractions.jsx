        ...
        <main className="page attractions-page">
            <section className="content-container">
                <div className="page-header">
                    ...
                    <p>
                        מתחילים מחיפוש במאגר הקיים, ורק אם אין התאמה — Miss Vivi מחפשת
                        מסביב בעזרת AI ומחזירה מקומות עם קישור מקור.
                    </p>
                </div>
                ...
                {isLoading && (
                    <div className="loading-card">
                        ...
                        <p>
                            קודם אנחנו בודקים אם קיימות אטרקציות מתאימות במאגר. אם לא נמצאות
                            תוצאות, Miss Vivi נעזרת ב־AI כדי למצוא מקומות אמיתיים עם קישור מקור.
                        </p>
                    </div>
                )}
